...
import dio.budgeting.application.MonthlySummaryUseCase;
...
public class TransactionController {
    ...
    public TransactionController(PersistTransactionUseCase persistTransactionUseCase,
                                 ...
                                 MonthlySummaryUseCase monthlySummaryUseCase) throws IOException {
        this.persistTransactionUseCase = persistTransactionUseCase;
        this.listTransactionsByCategoryUseCase = listTransactionsByCategoryUseCase;
        this.transcriptionModel = transcriptionModel;
        this.chatClient = chatClientBuilder
                .defaultSystem(systemPrompt.getContentAsString(Charset.defaultCharset()))
                .defaultTools(persistTransactionUseCase, listTransactionsByCategoryUseCase, monthlySummaryUseCase)
                .build();
